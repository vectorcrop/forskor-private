...
const DISCOUNT_PERCENTAGE = process.env.DISCOUNT_PERCENTAGE || 20;
const DISCOUNT_TOTAL_LIMIT = process.env.DISCOUNT_TOTAL_LIMIT || 500;

const SETTINGS = {
  DISCOUNT_PERCENTAGE: parseInt(DISCOUNT_PERCENTAGE),
  DISCOUNT_TOTAL_LIMIT: parseInt(DISCOUNT_TOTAL_LIMIT)
};
